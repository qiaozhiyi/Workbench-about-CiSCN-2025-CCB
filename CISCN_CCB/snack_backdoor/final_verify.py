...
# The key derived from glibc rand() stored in LE and read as BE
key = binascii.unhexlify("6172696b353230326365735f5f746572")
rk = expand_key(key)

# Test first command
c1 = binascii.unhexlify("49b351855f211b85bd012f80ce8ed5b3")
print(f"Decrypted C1: {decrypt_block(rk, c1)}")

# Test second command
c2 = binascii.unhexlify("b863696da0c6bb28da46e09069dd644f")
print(f"Decrypted C2: {decrypt_block(rk, c2)}")
